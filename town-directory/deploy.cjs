...
async function deploy() {
    ...
    try {
        ...
        const phpFiles = [
            ...
            "sim_world.php", "sim_level_up.php", "intake_actions.php", "scribe_actions.php", "lore_lib.php", "roster_generator.php", "auth.php",
            "upload_portrait.php", "upload_world_map.php", "app_public_lib.php", "helpers.php", "llm_training_dataset.php", "npc_flavor_pool.php", "character_sheet_library.php", "pricing.php", "llm_local.php", "import_srd.php",
            "import_5e_srd.php", "setup_srd_dbs.php", "migrate_srd.php", "reset_app_data.php", "discord.php", "discord_member_sync_lib.php",
            "discord_onboarding_lib.php", "discord_interactions.php",
            ...
            "stripe_billing_lib.php", "stripe_webhook.php", "config.stripe.php",
            "user_db.php",
        ];
